    ...
    if dbConnection: 
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute(insert_query, (user_info['role_id'], user_info['username'], user_info['email'], user_info['first_name'], user_info['last_name'], hashed_password, current_datetime))
